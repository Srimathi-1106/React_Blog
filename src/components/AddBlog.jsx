...
const AddBlog = ({addBlog}) => {
  ...
  return (
    <div className="h-screen flex flex-col justify-center items-center p-4 rounded shadow-md mb-6">
        <h2 className="text-xl font-bold mb-4">Add / Edit Blog</h2>
        <form onSubmit={handleSubmit} className='flex flex-col items-center shadow-md'>
          ...
          <input type="text" placeholder="Image URL" value={imageUrl} onChange={(e) => setImageUrl(e.target.value)} className="w-full p-2 border rounded mb-2"/>
